...
export const RUTAS: ReadonlyArray<Ruta> = [
  ...
  { ruta: 'propuestas',     indice: '04', titulo: 'Propuestas',      modulo: '../vistas/propuestas/vista',     roles: ['vendedor', 'administrador'], sesion: 'S5', enBarraInferior: true  },
  { ruta: 'dinero',         indice: '05', titulo: 'Dinero',          modulo: '../vistas/dinero/vista',         roles: ['vendedor', 'administrador'], sesion: 'S6', enBarraInferior: false },
  // ⛔ Ruta protegida: sólo administrador.
  { ruta: 'administracion', indice: '06', titulo: 'Administración',  modulo: '../vistas/administracion/vista', roles: ['administrador'],             sesion: 'S6', enBarraInferior: false },
];
